...
export default {
    ...
    data() {
        return {
            ...
            link_prev: '',
            photos: [
                'https://dev-mtown.g.kuroco-img.app/v=1677896033/files/user/images/2023/02/Mtown376_1.jpg',
                'https://dev-mtown.g.kuroco-img.app/v=1677896033/files/user/images/2023/02/Mtown376_2.jpg',
            ],
            index: null
        };
    },
